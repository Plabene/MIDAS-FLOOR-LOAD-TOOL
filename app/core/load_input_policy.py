...
from .load_parser import add_cad_direction_layer_prefix, normalize_cad_layer_name
...
DIRECTION_LAYERS = {
    *BASE_DIRECTION_LAYERS,
    *{add_cad_direction_layer_prefix(layer) for layer in BASE_DIRECTION_LAYERS},
}
DIRECTION_LAYER_NAMES_NORMALIZED = {normalize_cad_layer_name(layer) for layer in BASE_DIRECTION_LAYERS}
...
def is_direction_layer(layer: str) -> bool:
    return normalize_cad_layer_name(layer) in DIRECTION_LAYER_NAMES_NORMALIZED
